 ...
 */
public class Popup2List extends BasePopupWindow {
    ...
    private List<DictCity> mCities_one;
    private List<DictCity> mCities_two;
    private List<DictCity> mCities_three = new ArrayList<>();
    private String name_one;
    private int city_one, city_two;


    public Popup2List(final Activity context, final List<DictCity> mCities_one, final List<DictCity> mCities_two, String title) {
        super(context);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        for (int i = 0; i < mCities_two.size(); i++) {
                            if (mCities_two.get(i).getUpid() ==
                                    mCities_one.get(position).getCityid()) {
    ...
    class EduAdapter extends BaseAdapter {
        ...
        private List<DictCity> mEduLevels;
        private Context mContext;


        public EduAdapter(List<DictCity> eduLevels, Context context) {
    ...
    public interface FindDataCallBack {
        void findEduCallBack(String edu, int city_one_id, int city_two_id);
    }
}
