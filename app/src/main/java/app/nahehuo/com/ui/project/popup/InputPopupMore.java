 ...
 */
public class InputPopupMore extends BasePopupWindow implements View.OnClickListener{
    ...
    public InputPopupMore(Activity context) {
        super(context);
    ...
    @Override public View getPopupView() {
        return LayoutInflater.from(mContext).inflate(R.layout.popup_input_more,
                null);
    }
