package app.nahehuo.com.ui.job.popup;
...
public class PopupCommon extends BasePopupWindow
    ...
    TextView tv_cancel, tv_title, tv_sub_title,tv_ok;
    SetOnSelect mSetOnSelect;
    String title;
    String sub_title;


    public PopupCommon(Activity context, String title, String sub_title,
    ...
    @Override public View getPopupView() {
        return LayoutInflater.from(mContext)
                             .inflate(R.layout.popup_common, null);
    }
