 ...
 */
public class BinderBankCardPopup extends BasePopupWindow
    ...
    public BinderBankCardPopup(Activity context) {
        super(context);
    ...
    @Override public View getPopupView() {
        ...
        return LayoutInflater.from(mContext).inflate(R.layout.popup_binder_bank_card, null);
    }
