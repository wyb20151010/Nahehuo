 ...
 */
public class DeleteEduPopup extends BasePopupWindow
    ...
    public DeleteEduPopup(Activity context) {
        super(context);
    ...
    @Override public View getPopupView() {
        ...
        return LayoutInflater.from(mContext).inflate(R.layout.popup_delete_edu,
                null);
    }
