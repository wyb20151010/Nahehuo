 ...
 */
public class PartnerWorkExpActivity extends AppCompatActivity
        implements View.OnClickListener {

    private Toolbar mToolbar;
    private TextView tv_title, tv_entry_date, tv_out_date;
    private Context mContext;
    private LinearLayout ll_entry_date, ll_out_date;
    ...
    private void initView() {
        ...
        ll_out_date = (LinearLayout) findViewById(R.id.ll_out_date);
        ll_out_date.setOnClickListener(this);
    ...
    @Override public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ll_entry_date:
                ...
                break;
            case R.id.ll_out_date:
                getDateTime(tv_out_date);
                break;
        }
    }
