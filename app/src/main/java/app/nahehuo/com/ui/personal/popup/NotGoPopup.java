 ...
 */
public class NotGoPopup extends BasePopupWindow
    ...
    public NotGoPopup(Activity context) {
        super(context);
    ...
    @Override public View getPopupView() {
        ...
        return LayoutInflater.from(mContext).inflate(R.layout.popup_not_go_phone, null);
    }
