 ...
 */
public class DeleteFriPopup extends BasePopupWindow
    ...
    public DeleteFriPopup(Activity context) {
        super(context);
    ...
    @Override public View getPopupView() {
        ...
        return LayoutInflater.from(mContext).inflate(R.layout.popup_delete_fri, null);
    }
