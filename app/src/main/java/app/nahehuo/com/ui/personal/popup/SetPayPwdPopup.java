 ...
 */
public class SetPayPwdPopup extends BasePopupWindow
    ...
    public SetPayPwdPopup(Activity context) {
        super(context);
    ...
    @Override public View getPopupView() {
        ...
        return LayoutInflater.from(mContext).inflate(R.layout.popup_set_pay_pwd, null);
    }
