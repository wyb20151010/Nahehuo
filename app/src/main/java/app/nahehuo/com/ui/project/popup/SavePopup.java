 ...
 */
public class SavePopup extends BasePopupWindow implements View.OnClickListener {

    TextView tv_cancel;
    TextView tv_compelete;
    SetOnClickCallBack mCallBack;
    public SavePopup(Activity context ) {
        super(context);
    ...
    @Override public View getPopupView() {
        ...
        return LayoutInflater.from(mContext).inflate(R.layout.popup_save,null);
    }
