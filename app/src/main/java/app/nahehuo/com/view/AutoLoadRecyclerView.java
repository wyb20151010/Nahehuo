...
import app.nahehuo.com.interfa.LoadFinishCallBack;
import app.nahehuo.com.interfa.LoadMoreListener;
import com.nostra13.universalimageloader.core.ImageLoader;

/**
 * Created by wyb on 15/4/9.
 */
public class AutoLoadRecyclerView extends RecyclerView
  ...
  /*  public void setOnPauseListenerParams(boolean pauseOnScroll, boolean pauseOnFling) {
    ...
    @Override public void loadFinish(boolean isFinished) {
        isLoadingMore=isFinished;
    }
    ...
    private class AutoLoadScrollListener extends OnScrollListener {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (getLayoutManager() instanceof LinearLayoutManager) {
                ...
                int totalItemCount = AutoLoadRecyclerView.this.getAdapter()
                                                              .getItemCount();
