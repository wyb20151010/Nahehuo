    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if("1".equals(item.getStatus())){
            viewHolder.tv_status.setBackgroundDrawable(mContext.getResources
                    ().getDrawable(R.drawable.bg_zf_my_inter));
            viewHolder.tv_status.setTextColor(mContext.getResources()
                                                      .getColor(
                                                              R.color.jobtitlecolor));

        }else if("2".equals(item.getStatus())){
            viewHolder.tv_status.setBackgroundDrawable(mContext.getResources
                    ().getDrawable(R.drawable.bg_zf_my_inter2));
            viewHolder.tv_status.setTextColor(mContext.getResources()
                                                      .getColor(
                                                              R.color.white));
            ...
            viewHolder.tv_status.setBackgroundDrawable(mContext.getResources
                    ().getDrawable(R.drawable.bg_zf_my_inter3));
            viewHolder.tv_status.setTextColor(mContext.getResources()
                                                      .getColor(
                                                              R.color.white));
        }else if("3".equals(item.getStatus())){
            viewHolder.tv_status.setBackgroundDrawable(mContext.getResources
                    ().getDrawable(R.drawable.bg_zf_my_inter4));
            viewHolder.tv_status.setTextColor(mContext.getResources()
                                                      .getColor(
                                                              R.color.white));
        }
